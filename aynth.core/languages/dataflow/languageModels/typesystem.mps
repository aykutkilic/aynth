...
<model modelUID="r:847c80d4-cdd5-4289-a92f-b3585825010f(com.mbeddr.dataflow.typesystem)">
  ...
  <roots>
    ...
    <node type="tpd4.InferenceRule" typeId="tpd4.1174643105530" id="6057175373189978463">
      <property name="name" nameId="tpck.1169194664001" value="typeof_ProcessorPinRefExpr" />
      <property name="virtualPackage" nameId="tpck.1193676396447" value="structure" />
    </node>
  </roots>
  ...
  <root id="3140209388624473345">
    ...
    <node role="applicableNode" roleId="tpd4.1174648101952" type="tpd4.ConceptReference" typeId="tpd4.1174642788531" id="3140209388624473347">
      ...
      <link role="concept" roleId="tpd4.1174642800329" targetNodeId="adf4.3140209388624398771" resolveInfo="ProcessorMemberRef" />
    </node>
  </root>
  ...
  <root id="6057175373189978463">
    <node role="body" roleId="tpd4.1195213635060" type="tpee.StatementList" typeId="tpee.1068580123136" id="6057175373189978464">
      <node role="statement" roleId="tpee.1068581517665" type="tpd4.CreateEquationStatement" typeId="tpd4.1174658326157" id="6057175373189978488">
        <node role="rightExpression" roleId="tpd4.1174660783414" type="tpd4.NormalTypeClause" typeId="tpd4.1185788614172" id="6057175373189978492">
          <node role="normalType" roleId="tpd4.1185788644032" type="tpee.DotExpression" typeId="tpee.1197027756228" id="6057175373189978547">
            <node role="operand" roleId="tpee.1197027771414" type="tpee.DotExpression" typeId="tpee.1197027756228" id="6057175373189978521">
              <node role="operand" roleId="tpee.1197027771414" type="tpd4.ApplicableNodeReference" typeId="tpd4.1174650418652" id="6057175373189978493">
                <link role="applicableNode" roleId="tpd4.1174650432090" targetNodeId="6057175373189978465" resolveInfo="ppre" />
              </node>
              <node role="operation" roleId="tpee.1197027833540" type="tp25.SLinkAccess" typeId="tp25.1138056143562" id="6057175373189996647">
                <link role="link" roleId="tp25.1138056516764" targetNodeId="adf4.6688546463199361461" />
              </node>
            </node>
            <node role="operation" roleId="tpee.1197027833540" type="tp25.SLinkAccess" typeId="tp25.1138056143562" id="6057175373189978553">
              <link role="link" roleId="tp25.1138056516764" targetNodeId="mj1l.318113533128716676" />
            </node>
          </node>
        </node>
        <node role="leftExpression" roleId="tpd4.1174660783413" type="tpd4.NormalTypeClause" typeId="tpd4.1185788614172" id="6057175373189978491">
          <node role="normalType" roleId="tpd4.1185788644032" type="tpd4.TypeOfExpression" typeId="tpd4.1174657487114" id="6057175373189978467">
            <node role="term" roleId="tpd4.1174657509053" type="tpd4.ApplicableNodeReference" typeId="tpd4.1174650418652" id="6057175373189978469">
              <link role="applicableNode" roleId="tpd4.1174650432090" targetNodeId="6057175373189978465" resolveInfo="ppre" />
            </node>
          </node>
        </node>
    ...
    <node role="applicableNode" roleId="tpd4.1174648101952" type="tpd4.ConceptReference" typeId="tpd4.1174642788531" id="6057175373189978465">
      <property name="name" nameId="tpck.1169194664001" value="ppre" />
      <link role="concept" roleId="tpd4.1174642800329" targetNodeId="adf4.3784687083654961589" resolveInfo="ProcessorPinRefExpr" />
    </node>
  </root>
</model>
